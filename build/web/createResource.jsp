    ...
    <body>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="">Resource <span class="sr-only">(current)</span></a>
        ...
        <form action="upload" method="POST" enctype="multipart/form-data">
            <div class="input-group">
                ...
                <input type="text" aria-label="First name" class="form-control" name="txtNombre">
                <input type="text" aria-label="Last name" class="form-control" name="txtApellido">
            </div>
